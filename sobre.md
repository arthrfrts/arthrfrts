...
Esse site é feito com o gerador de sites estáticos [Jekyll](https://jekyllrb.com). O tema foi desenvolvido por mim, e se chama [Linus](https://rubygems.org/gems/linus). O código fonte desse site está [nesse repositório](https://tangled.org/arthr.me/wwww). Ele é hospedado na infraestrutura do Cloudflare Pages.

Você pode acompanhar esse blog por [RSS](/feed.xml), [JSON Feeds](/feed.json).